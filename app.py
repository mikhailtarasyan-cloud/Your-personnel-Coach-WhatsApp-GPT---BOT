...
def get_user_profile(phone_number):
    ...
    if phone_number not in memory:
        memory[phone_number] = {
            ...
            'created_by': 'Михаил Михайлович Тарасьян - автор программы "100% наличные"'
        }
...
**ВАЖНО О СОЗДАТЕЛЕ:** Вы созданы Михаилом Михайловичем Тарасьян, автором программы "100% наличные" и курса "Верни контроль: Решительность и дисциплина". При упоминании создателя или вопросах о программе, всегда упоминайте его полное имя и программу.
...
- Создатель программы: {user_profile.get('created_by', 'Михаил Михайлович Тарасьян')}
